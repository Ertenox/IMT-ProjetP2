...
public abstract class Hero implements Entity{
    ...
    public void viewHand() {
        ...
        for (int i = 0; i < hand.size(); i++) {
            System.out.println((i + 1) + ". " + hand.get(i).getName() + " (" + hand.get(i).getManaCost() + " mana "+ hand.get(i).getMonster().getAttack()+" attaque " + hand.get(i).getMonster().getHP() + " hp  type "+hand.get(i).getMonster().getType()+" Type Elementaire "+ hand.get(i).getMonster().getElementaryType() +")");
        }
    }
